...
<div class="h-[calc(100vh-80px)] w-72 bg-slate-50 absolute ease-in-out transition-all duration-300 z-30 left-0 top-[70px] pr-4 {showSidebar ? 'translate-x-0' : '-translate-x-full'}">
    <div class="pl-4 py-4">
        <Contact />
    </div>
    <div class="w-full flex items-center justify-between bg-blue-100 text-blue-700 rounded-r-full py-2 text-sm px-6 font-semibold">
        <div class="flex">
