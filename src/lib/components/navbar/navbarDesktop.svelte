...
<div class="navbar-container px-8 py-2">
    ...
    <div class="flex items-center space-x-4">
        <div class="flex h-10 px-5 rounded-full border border-slate-200 text-slate-500 font-medium text-sm hover:bg-slate-200 hover:border-slate-100 justify-center items-center">
