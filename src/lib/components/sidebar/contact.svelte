...
<button on:click={() => {$metaStore.showContactForm = true}} class="bg-cyan-100 text-blue-900 hover:shadow-md py-4 pr-6 pl-4 rounded-xl flex items-center font-medium">
