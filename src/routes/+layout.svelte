...
<div class="page-container">
    ...
    <div class="fixed w-full pr-2 pb-3 ease-in-out transition-all duration-300 {($metaStore.showSidebar && $metaStore.screen === 'desktop') ? 'pl-72' : 'pl-2'} h-[calc(100vh-5rem)]">
        <div class="bg-white rounded-xl h-full">
            ...
            <div class="flex h-[calc(100vh-10rem)] overflow-y-auto w-full border-t-2 border-slate-200">
                <div class="{$metaStore.screen === 'desktop' ? 'border-r border-slate-200 min-w-fit': 'w-full'} overflow-y-auto"><EmailList/></div>
